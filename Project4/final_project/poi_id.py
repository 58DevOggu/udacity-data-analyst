...
features_list = [op_label] + financial_features_list + email_features_list 
...
## Total and Travel Agency are evident , For Lochart there are no entries in the dataset
...
my_feature_list = [op_label] + best_features.keys()

###Add new features
helper.add_networth(my_dataset, my_feature_list)
